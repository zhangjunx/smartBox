	 ...
	 lay('.date').each(function() {
	  ...
	  table.render({
		    ...
		    cols:  [[
			      ...
			      {field:'PHONENUM', title:'性别', width:200,sort:true},
			      {field:'STUDENTS', title:'楼栋名称', width:250,sort:true},
			      {field:'CREATEDATE', title:'门牌号', width:200,sort:true},
				  {field:'CREATEDATE', title:'进出通道', width:250,sort:true},
